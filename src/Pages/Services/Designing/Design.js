                                            ...
                                            <div className='row'>
                                                <div className='col-lg-8 col-sm-8 col-12'>
                                                    ...
                                                    <h5 className='linkstyle'>
                                                        <a href="/portfolio/graphic-designing">View Portfolio <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className='row'>
                                            <div className='portfolio-element'>
                                                <div className='element'>
                                                    <img src={require('../../../img/services/port-preview/1.png')} />
                                                </div>
                                            </div>
                                            <div className='portfolio-element'>
                                                <div className='element'>
                                                    <img src={require('../../../img/services/port-preview/2.png')} />
                                                </div>
                                            </div>
                                            <div className='portfolio-element'>
                                                <div className='element'>
                                                    <img src={require('../../../img/services/port-preview/3.png')} />
                                                </div>
                                            </div>
                                            <div className='portfolio-element'>
                                                <div className='row'>
                                                    <div className='portfolio-element'>
                                                        <div className='element'>
                                                            <img src={require('../../../img/services/port-preview/4.png')} />
                                                        </div>
                                                    </div>
                                                    <div className='portfolio-element'>
                                                        <div className='element'>
                                                            <img src={require('../../../img/services/port-preview/5.png')} />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className='row'>
                                                    <div className='portfolio-element'>
                                                        <div className='element'>
                                                            <img src={require('../../../img/services/port-preview/6.png')} />
                                                        </div>
                                                    </div>
                                                    <div className='portfolio-element'>
